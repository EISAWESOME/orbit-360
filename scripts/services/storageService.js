...
(function () {
    ob.service('storageService', ['$mdToast',
        function ($mdToast) {
            ...
            //Retourne titre, desc, et details du xml chargé si ils existe
            this.loadXml = function (id, tooltips, angle, lookupAngle, dataXML) {
                ...
                if (xml) {
                    ...
                    if (xml.getElementsByTagName("property").length > 0) {
                        const colProperties = xml.getElementsByTagName(
                            "property"
                        );
                        ...
                        Images.loadDetails().then(function (dataXML) {
                            ...
                            const colProperties = details.getElementsByTagName(
                                "property"
                            );
                            for (let i = 0; i < colProperties.length; i++) {
                                if (
